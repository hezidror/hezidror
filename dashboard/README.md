...
### זיהוי טיפול לפי צבע האירוע (אופציונלי)

במקום להקליד את שם הטיפול בשדה מיקום בכל פעם, אפשר לבחור **צבע** לאירוע
ביומן (Google Calendar מציע 11 צבעים קבועים) והדשבורד יזהה את הטיפול
מהצבע במקום מהמיקום. שימושי לטיפולים הנפוצים ביותר (עד 11 - זו מגבלה
קשיחה של גוגל); טיפולים נדירים יותר ממשיכים לעבוד כרגיל דרך שדה מיקום.

כדי להגדיר זאת: בגיליון ה-Prices, הוסיפו עמודה שלישית (C) עם כותרת
`צבע`, ולכל טיפול שרוצים לזהות לפי צבע כתבו את שם הצבע (בעברית או
באנגלית) בדיוק כפי שהוא מופיע בבורר הצבעים של Google Calendar:

| צבע בעברית | צבע באנגלית |
|---|---|
| לבנדר | Lavender |
| מרווה | Sage |
| ענבים | Grape |
| פלמינגו | Flamingo |
| בננה | Banana |
| קלמנטינה / כתום | Tangerine |
| טווס | Peacock |
| גרפיט / אפור | Graphite |
| אוכמניות / כחול | Blueberry |
| בזיליקום / ירוק כהה | Basil |
| עגבנייה / אדום | Tomato |

טיפול בלי צבע מוגדר בעמודה C ימשיך להיקרא כרגיל משדה המיקום ביומן -
אין צורך לשנות שום דבר קיים, זו תוספת בלבד.
